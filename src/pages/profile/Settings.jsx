...
function ProfileSettings() {
  const { user, updateProfile, updateNotifications, loading, error, clearError } = useAuth();
      ...
      <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
        ...
        <form onSubmit={handleProfileSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={loading}
            className="rounded-xl bg-brand-blue px-6 py-2.5 text-sm font-bold text-white hover:bg-brand-navy transition-colors disabled:opacity-50 cursor-pointer"
          >
