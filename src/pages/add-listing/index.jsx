...
const CATEGORY_FIELDS = {
  ...
  'vehicle': [
    ...
    { name: 'condition', label: 'Condition', type: 'select', options: ['new', 'old'] },
    { name: 'category', label: 'Category', type: 'select', options: ['2-wheeler', '3-wheeler', '4-wheeler', 'commercial'] },
    { name: 'fuelType', label: 'Fuel Type', type: 'select', options: ['Petrol', 'Diesel', 'Electric', 'CNG'] },
    { name: 'transmission', label: 'Transmission', type: 'select', options: ['Manual', 'Automatic', 'CVT', 'DCT', 'AMT'] },
    { name: 'kmDriven', label: 'KM Driven', type: 'number', placeholder: 'e.g. 15000' },
...
const INITIAL = {
  ...
  brand: '', model: '', year: '', condition: '', fuelType: '', category: '', transmission: '', kmDriven: '',
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const apiCalls = {
        ...
        'vehicle': () => vehicleAPI.create({
          make: form.brand, model: form.model, year: Number(form.year),
          condition: form.condition || 'old',
          category: form.category || '4-wheeler',
          fuelType: form.fuelType || 'Petrol',
          transmission: form.transmission || undefined,
          kmDriven: Number(form.kmDriven) || 0,
          price: form.price,
          priceValue: parseFloat(form.price.replace(/[₹,\s]/g, '')) || 0,
          location: form.area,
          city: form.city,
